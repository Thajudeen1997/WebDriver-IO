...
exports.config = {
    ...
    //
    specs: [
        // './test/specs/applyForInternetBanking.js',
        // './test/specs/jsonPractise.js',
    ...
    suites:{
        smokeSuite:['./test/specs/ApproveAndDeleteAccount.js','./test/specs/openandApproveAccount.js'],
        regressionSuite:['./test/specs/openApproveAndapplyfordebitcard.js']
    },
    // Patterns to exclude.
    exclude: [
        // 'path/to/excluded/files'
        // './test/specs/DemoWebShop.js',
        // './test/specs/**/*.js',
        // './test/specs/testRun.js'
    ],
    //
    // ============
    // Capabilities
